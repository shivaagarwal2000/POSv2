...
//            OrderItemPojo orderItemPojo = OrderDtoHelper.convert(form, productPojo, orderPojo.getId());
...
//            InventoryPojo inventoryPojo = inventoryService.get(productPojo.getId());// TODO yes, This is being used too many times, move to a seprate function in OrderDto Priority: 5
...
//            }
    ...
    //TODO: sales report - change to get all filters.
...
//        System.out.println(orderPojos);
    ...
    public List<OrderItemPojo> convert(int orderId, List<OrderItemForm> forms) throws ApiException {
    ...
    public void validateOrderForm(OrderItemForm form) throws ApiException {
...
//            throw new ApiException("Error: not enough quantity to fulfil -" + productPojo.getName());
//        }
        validateInventory(form.getQuantity(), productService.get(form.getBarcode()));
    }

    public void validateInventory(int orderItemQuantity, ProductPojo productPojo) throws ApiException {
        InventoryPojo inventoryPojo = inventoryService.get(productPojo.getId());
    ...
    public void validateListOrderForm(List<OrderItemForm> forms) throws ApiException {
        for (OrderItemForm form : forms) {
