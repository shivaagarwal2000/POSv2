...
public class BrandDtoTest extends AbstractUnitTest {
    ...
    public void testAdd() throws ApiException {
        ...
        BrandForm brandForm = posTestHelper.createBrandForm("  Brand-test  ", "brand_category");
    ...
    public void testEmptyBrandAdd() throws ApiException {
        ...
        try {
            BrandForm brandForm = posTestHelper.createBrandForm("", "category-test");
            brandDto.add(brandForm);
    ...
    public void testEmptyCategoryAdd() throws ApiException {
        ...
        try {
            BrandForm brandForm = posTestHelper.createBrandForm("brand-test", "");
            brandDto.add(brandForm);
        } catch (final ApiException apiException) {
    ...
    public void testCategoryLengthOnAdd() {
        ...
        try {
            ...
            BrandForm brandForm = posTestHelper.createBrandForm("brand-test", category);
            brandDto.add(brandForm);
        } catch (final ApiException apiException) {
    ...
    public void testBrandLengthOnAdd() {
        ...
        try {
            ...
            BrandForm brandForm = posTestHelper.createBrandForm(brand, "category-test");
            brandDto.add(brandForm);
        } catch (final ApiException apiException) {
            final String ERROR_MSG = "Error: length of brand, category exceeds maximum limit";
            assertEquals(apiException.getMessage(), ERROR_MSG);
    ...
    public void testUpdate() throws ApiException {
        BrandForm brandForm = posTestHelper.createBrandForm("brand", "category");
        brandDto.add(brandForm);
        BrandForm newBrandForm = posTestHelper.createBrandForm("new_brand", "new_category");
